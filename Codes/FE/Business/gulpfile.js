...
gulp.task('scripts', function() {
  return gulp.src([resolve('zepto/zepto.min.js'),
...
gulp.task('copy',function(){
    return gulp.src([resolve('qrcodejs/qrcode.min.js')])
    .pipe(gulp.dest(dist))
})
...
gulp.task('default',['scripts','styles','copy','compress:js','compress:h5']);
