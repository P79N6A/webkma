        ...
        <div class="data-overview" style="border:1px solid #e6e6e8;">
            ...
            <div class="overview-body" style="height:160px;">
                <div style="height:80px;">
                    <div class="pull-left" style="width:304px;border-right:1px solid #e6e6e8;text-align:center;">
                        <p class="font-14 black-light" style="margin-bottom:10px;">总金额（元）</p>
                        <p><span class="font-36 red-light">{{totalReport.extensionCost}}</span><span class="font-14 black-light"> 元</span></p>
                    </div>
                    <div class="pull-left" style="width:870px;">
                        <table style="margin-left:20px;">
                            <tr>
                                ...
                                <td class="text-center" style="width:180px;">
                                    ...
                                    <p><span class="font-24 red-light">{{totalReport.clickRate}}%</span></p>
                                </td>
                                <td class="text-center" style="width:180px;">
                                ...
                                <td class="text-center" style="width:220px;">
                                    ...
                                    <p><span class="font-24 red-light">{{totalReport.conversionCost}}</span><span class="font-14 black-light"> 元</span></p>
                                </td>
                            </tr>
                        </table>
                    </div>
