...
angular.module('managementApp')
  .controller('MaterialTextCtrl', ["$scope", "materialListService", "messenger","userListService","$location","$timeout",
    function ($scope, materialListService, messenger,userListService,$location,$timeout) {
      ...
      $scope.getImgMaterialList = function (callback) {
        ...
        materialListService.getMaterialList(options, function (json) {
          if (json.code === 0) {
            ...
            messenger.error('获取文本素材列表失败:' + json.desc);
          }
          !!callback && callback();
        });
      };
      ...
      $scope.getMaterialTagList = function(){
          var _data = {
              ...
              tagType: '6',//标签类别，1:模板 ,2:H5,3:短信,4:邮件，5客户 6文本 7图片 8形态 9背景  如果为null 或者 为 0则查询全部标签
