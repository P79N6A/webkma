...
(function (factory) {
    ...
    $.widget("ui.resizable", $.ui.mouse, {
        ...
        _mouseStart: function (event) {
            ...
            // 解决通过option设置等比缩放失效的问题  By Dyllon 2018/07/27
            this._aspectRatio = !!o.aspectRatio;
            ...
            this.refresh = function () {
                ...
                that.selectees.each(function () {
                    ...
                    $.data(this, "selectable-item", {
                        ...
                        right: pos.left + Kdo.featurer.rotate.rotateStyle($this).width,
                        bottom: pos.top + Kdo.featurer.rotate.rotateStyle($this).height,
                        startselected: false,
