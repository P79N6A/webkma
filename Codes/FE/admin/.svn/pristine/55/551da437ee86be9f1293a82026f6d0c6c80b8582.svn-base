<template>
  <div class="app-login">
    <div class="logo">
      <a href="index.html">
        <img style="vertical-align: middle;border:none;" src="../assets/images/logo.png" alt />
      </a>
      <span>管理后台</span>
    </div>
    <div class="content">
      <div class="form">
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" @keyup.enter.native="submitForm('ruleForm')" class="form-container">
          ...
          <el-form-item prop="loginPwd">
            ...
            <el-input type="text" onfocus="this.type='password'" v-model="ruleForm.loginPwd" placeholder="请输入您的密码" autocomplete="off" @focus="changeSelectPwd"></el-input>
          </el-form-item>
...
export default {
  ...
  mounted() {
    ...
    //   this.$router.push("/bussiness-list")
    // }
