let structConfig = {
    "text": {
        ...
        "addTools": ["font-toolbar", "opacity", "lock", "alignposition", "update"]
    },
    "image": { 
        "struct": "image",
        "name": "图片",
        ...
        "data": { "src": "" },
        "addTools": ["choose-image", "opacity", "horizontal-transform", "vertical-transform", "stretch", "lock", "alignposition", "update"],
        "aspectRatio": true
    },
    "svg": {
        "struct": "svg",
        ...
        "resourceSrc": "",
        "addTools": ["choose-colors", "opacity", "horizontal-transform", "vertical-transform", "lock", "alignposition", "update"],
        "aspectRatio": true
    },
    "div": {
        "struct": "div",
    ...
    "adsorb": {
        ...
        "addTools": ["choose-image", "opacity", "horizontal-transform", "vertical-transform", "lock", "alignposition", "update"]
    },
    "game": {
        "struct": "game",
        "name": "游戏",
