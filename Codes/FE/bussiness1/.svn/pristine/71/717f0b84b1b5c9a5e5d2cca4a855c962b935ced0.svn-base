<template>
  <div class="forwardingUser">
    <div class="header-seach">
      ...
      <div class="query-box">
        <el-select placeholder="活动类型" size="mini" style="border-radius:none;margin-right:10px;width:100px" v-model="data_.maxLevel" 
          @change="optionSelect()">
    ...
    <el-table :data="tableData" style="width: 98%;margin:0 auto" :header-cell-style="{background:'#F7FBFC'}"
      ...
      <el-table-column prop="level" label="人脉层级"  align="center" sortable="custom">
      </el-table-column>
       <el-table-column prop="forwardCount" label="转发次数" align="center"  sortable="custom">
      </el-table-column>
      <el-table-column prop="userCount" label="带来浏览人数" align="center"  sortable="custom">
      </el-table-column>
      <el-table-column prop="browseCount" label="带来浏览次数" align="center"  sortable="custom">
      </el-table-column>
...
export default {
  ...
  methods: {
    taskBrowseList(cb) {
      ...
      api.request('taskForwardList', option, result => {
        if (result.status === 0) {
