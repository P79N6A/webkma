...
Page({
  ...
  toRecordInfo:function (e){
    wx.navigateTo({
      url: '/pages/red-envelopes-detail/red-envelopes-detail?active=' + e.currentTarget.dataset.active + '&id=' + e.currentTarget.dataset.id + '&sendstate=' + e.currentTarget.dataset.sendstate
    })
  },
