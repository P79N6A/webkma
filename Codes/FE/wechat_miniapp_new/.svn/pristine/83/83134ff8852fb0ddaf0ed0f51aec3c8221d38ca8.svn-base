  ...
  getCustomerInfo: function () {
    ...
    activityService.getCustomerInfo({
      ...
      if (res.status == 0) {
        ...
        var redizhi = [];
        var dizhi = redizhi.push(res.data.province, res.data.city, res.data.region);
        self.setData({
          form: {
          ...
          address: res.data.area == null ? '' : res.data.area,
